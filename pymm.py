...
def main(data_dir, scale):
    pose_db, features_db = load_data(data_dir, scale)
    ...
    while not window_should_close():
        ...
        root_joint_pos = pose_db[frame_index, 0]
        ...
        current_pose = pose_db[frame_index]
...
if __name__ == "__main__":
    ...
    parser.add_argument("--scale", type=float, default=0.01, help="Scale factor for the animation")
    args = parser.parse_args()

    main(args.data_dir, args.scale)
